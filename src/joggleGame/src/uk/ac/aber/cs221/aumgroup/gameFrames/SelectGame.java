...
public class SelectGame extends javax.swing.JFrame {
	...
	/**
	 * This method loads the previously saved games and makes them available for selection
	 * for the user to play
	 */
    private void loadSavedGames(){
        File gamesFolder = new File("src/uk/ac/aber/cs221/aumgroup/resources/savedGames");
