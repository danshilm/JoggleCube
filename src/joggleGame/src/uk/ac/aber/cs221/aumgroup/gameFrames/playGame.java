...
public class playGame extends javax.swing.JFrame {
    ...
    private void populateGrids() {
        ...
        grid1.generateRandomLetters();  //generate random letters for grid 1
        grid1.populateGrid();  // fill the grid
        grid2Tiles = new Tile[] { g2R0C0, g2R0C1, g2R0C2, g2R1C0, g2R1C1, g2R1C2, g2R2C0, g2R2C1, g2R2C2 };
        grid2.setAllTiles(grid2Tiles);
        grid2.generateRandomLetters(); //generate random letters for grid 2
        grid2.populateGrid();  // fill the grid
        grid3Tiles = new Tile[] { g3R0C0, g3R0C1, g3R0C2, g3R1C0, g3R1C1, g3R1C2, g3R2C0, g3R2C1, g3R2C2 };
        grid3.setAllTiles(grid3Tiles);
        grid3.generateRandomLetters(); //generate random letters for grid 3
        grid3.populateGrid();  // fill the grid
    }
     ...
     *
     * @param evt event of tile handling
     *
     */
